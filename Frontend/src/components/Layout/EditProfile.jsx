...
const EditProfile = () => {
  ...
  useEffect(() => {
    ...
    dob.current.value = profileData?.dob
        ...
        <div className="m-auto  bg-slate-200 md:w-1/2 py-8 md:py-0 px-3 md:px-0 h-auto shadow-lg rounded-4xl">
          <div className="text-center">
            ...
            <p className="text-sm pt-1 font-sans text-slate-500">
              Personalize your profile by updating the details that matter.
            </p>
          </div>
          <form
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 md:gap-4 px-4 md:px-15 mt-5 font-sans font-medium">
              <button
                type="submit"
                className="w-full sm:w-40 md:w-50 h-9 bg-emerald-500 cursor-pointer text-slate-950 rounded-lg hover:text-white"
              >
                Update Profile
              </button>
              <button
                className="w-full sm:w-40 md:w-50 h-9 border border-[#132639] bg-transparent cursor-pointer text-slate-950 rounded-lg"
                onClick={(e) => backClicked(e)}
              >
                Back
              </button>
            </div>
