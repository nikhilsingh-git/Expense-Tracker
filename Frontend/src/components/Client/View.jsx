...
const View = () =>{
    ...
    try {
            const response = await axios.delete(`http://localhost:3000/api/expense/deleteExpense/${expenseId}` , {withCredentials:true})
    ...
    try {
            ...
            const response = await axios.delete(`http://localhost:3000/api/auth/deleteIncome/${incomeId}` , {withCredentials:true})
  ...
  <div className="w-100 bg-[#071321] border mt-40 border-[#132739] rounded-xl shadow-2xl p-6">
    <div className="flex justify-center">
      <div className="w-14 h-14 rounded-full bg-red-500/20 flex items-center justify-center">
        <span className="text-3xl text-red-500"><MdDelete /></span>
      </div>
    </div>
        ...
        <div>
         ...
         <div>
            <div className=" text-gray-200 bg-[#071321] h-140 my-20 mx-20 overflow-scroll scrollbar-hide rounded-2xl shadow-[0_0_20px_rgba(100,102,50,0.3)]">
                ...
                <div className="text-center m-auto mt-53 h-30 w-60 border border-[#132739] flex justify-center items-center
