  ...
  return (
    <>
      <div>
        ...
        <div className="md:flex justify-between md:px-20 px-7 mt-10">
          <div className="flex flex-col">
            <div className="flex border justify-around bg-[#071321] border-[#132739] rounded-2xl relative md:w-130 w-80 md:px-10 md:py-7 py-3 px-3">
              <div
                onClick={(e) => {
                  handelExpenseClick();
                }}
              >
                <FaArrowAltCircleDown className="absolute md:top-11 top-5 md:left-18 md:text-lg cursor-pointer" />
                <button className="bg-[#4A2730] md:w-50 w-30  md:h-12 h-8 rounded-xl text-[#FF5B6A] md:text-lg text-sm font-sans md:font-bold cursor-pointer">
                  {" "}
                  Add Expense
                </button>
              </div>
              <div onClick={(e) => handelIncomeClick(e)}>
                <FaArrowAltCircleUp className="absolute md:top-11 top-5 md:left-73 md:text-lg cursor-pointer" />
                <button className="bg-[#123A35] md:w-50 w-30 md:h-12 h-8 rounded-xl text-[#1ED7A5] md:text-lg text-sm font-sans md:font-bold cursor-pointer">
                  Add incoms
                </button>
              </div>
            </div>
                ...
                <form onChange={onChange}>
                  ...
                  <div className="flex flex-col font-sans font-medium mx-10">
                    ...
                    <textarea
                      name=""
                      id=""
                      className="rounded-md bg-[#112439] mt-2 mb-5 outline-0 px-5"
                      rows={3}
                      ref={description}
                    ></textarea>
                    ...
                    <div className="flex justify-around gap-4">
                      <button
                        className="bg-[#112439] md:w-45 w-40 h-10 md:h-11 rounded cursor-pointer"
                        onClick={(e) => handelOnIncomeCancel(e)}
                      >
                        Cancel
                      </button>
                      <button
                        className="bg-emerald-500 md:w-45 w-40 h-10 md:h-11 rounded cursor-pointer"
                        onClick={(e) => haldelOnIncome(e)}
                      >
                        Add incom
                      </button>
                    </div>
                ...
                <form onChange={onChange}>
                  ...
                  <div className="flex flex-col font-sans font-medium mx-10">
                    ...
                    <div className="flex justify-around gap-4">
                      <button
                        className="bg-[#112439] md:w-45 w-40 h-10 md:h-11 rounded cursor-pointer"
                        onClick={(e) => handelOnCancelClick(e)}
                      >
                        Cancel
                      </button>
                      <button
                        className="bg-emerald-500 md:w-45 w-40 h-10 md:h-11 rounded cursor-pointer"
                        onClick={(e) => haldelOnExpense(e)}
                      >
                        Add Expense
                      </button>
                    </div>
          ...
          <div className=" md:w-110 mb-10">
            <div className="bg-[#071321] h-100 border border-[#132739]  rounded-2xl px-12 ">
              <h1 className="text-xl text-gray-300 pt-6 font-sans font-medium">
                Quick Category
              </h1>
              <div className=" grid grid-cols-3 grid-rows-3 gap-6  mt-5 ">
                <div
                  className="h-20 w-20 bg-[rgb(17,36,57)] rounded-xl gap-4 border border-[#132739] flex flex-col justify-center items-center cursor-pointer
                ...
                >
                  ...
                  <h1 className="text-xs font-medium font-sans text-gray-200 pb-3">
                    Food
                  </h1>
                </div>

                <div
                  className="h-20 w-20 bg-[#112439] rounded-xl gap-4  border border-[#132739] flex flex-col justify-center items-center cursor-pointer
            ...
            <div className="md:w-110 w-80 h-70 border text- border-[#132739] rounded-xl mt-2 overflow-scroll scrollbar-hide bg-[#071321]">
              <div>
                <h1 className="text-gray-200 font-sans text-xl font-medium px-8 pt-4">
                  Recent Transctions
                </h1>
              </div>
              ...
              {expense?.length === 0 && income?.length === 0 ? (
                <div
                  className="text-center m-auto mt-15 h-15 w-30 border border-[#132739] flex justify-center items-center
                ...
                <div className="py-3 px-5 flex flex-col gap-3">
                  {expense.map((item) => (
                    <div
                      className="flex justify-between border border-[#132739] rounded-lg "
                      key={item._id}
                    >
                      <div className="px-5">
                      ...
                      <div className=" px-5 text-red-400">-{item.amount}</div>
                    </div>
                  ))}
                  {income.map((item) => (
                    <div
