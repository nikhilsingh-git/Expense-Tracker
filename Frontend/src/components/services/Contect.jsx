...
<>  
    ...
    <div className="flex justify-around pr-10  w-full pb-10 text-gray-200"> 
    <div className=" ms-25 ">
        ...
        <div>
            <form>
                ...
                rows={4}></textarea>
                <button className="text-md mx-30 border border-gray-300 rounded-xl font-sans font-medium text-gray-100 bg-transparent w-45 h-10 text-center cursor-pointer
    ...
    <div >
        ...
        <div className="border-3 rounded-2xl px-5 py-2 border-[#1329]">
        <div className="w-180 mx-10 cursor-pointer hover:translate-y-2">
            <div className="w-full h-26 border-2 border-[#1329] rounded-2xl my-12 relative flex flex-col justify-center ">
                ...
                <p className="text-sm pb-5 pt-1" >nikhilsingh811528@gmail.com</p>
                </div>
            </div>
        </div>
         ...
         <div className="w-180 mx-10 cursor-pointer hover:translate-y-2">
            <div className="w-full h-26 border-2 border-[#1329] rounded-2xl my-12 relative flex flex-col justify-center">
                ...
                <div className="ms-25 font-sans pt-2">
                <h1 className="text-2xl font-bold">Phone & Whatsapp</h1>
                <p className="text-sm pb-5 pt-1" >+91 6388919519</p>
                </div>
            </div>
        </div>
         ...
         <div className="w-180 mx-10 cursor-pointer hover:translate-y-2">
            <div className="w-full h-26 border-2 border-[#1329] rounded-2xl my-12 relative flex flex-col justify-center">
                ...
                <p className="text-sm pb-5 pt-1" >Unwal, Gorakhpur <br />U.P , India - 273406</p>
                </div>
            </div>
        </div>
         ...
         <div className="w-180 mx-10 cursor-pointer hover:translate-y-2 ">
            <div className="w-full h-26 border-2 border-[#1329] rounded-2xl my-12 relative flex flex-col justify-center">
                ...
                <p className="text-sm pb-5 pt-1" >Monday - Friday <br /> 
                 11:00 AM - 7:00 PM
                </p>
                </div>
            </div>
    ...
    <div className="px-40">
         <div className="w-full   border-2 border-[#1329] rounded-2xl flex justify-between">
            <div className="w-full h-26 relative">
                ...
                <div className="ms-25 font-sans pt-2 text-gray-200 mt-2">
                <h1 className="text-2xl font-bold">Contect with me</h1>
                <p className="text-sm pb-5 pt-1" >I'm available for freelance projects and collaborations.</p>
                </div>
            </div>
            <div className="flex justify-around items-center gap-8 text-4xl pr-10 text-gray-200">
                <div className="cursor-pointer hover:font-bold font-sans hover:translate-y-1 hover:shadow-[0_0_10px_rgba(150,150,150,0.5)]"><FaInstagram /></div>
                <div className="cursor-pointer hover:font-bold font-sans hover:translate-y-1 hover:shadow-[0_0_10px_rgba(150,150,150,0.5)]"><FaGithub /></div>
                <div className="cursor-pointer hover:font-bold font-sans hover:translate-y-1 hover:shadow-[0_0_10px_rgba(150,150,150,0.5)]"><FaLinkedin /></div>
            </div>
        </div>
    </div>
    </div>
